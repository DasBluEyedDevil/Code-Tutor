// Script to add DEEP_DIVE section on loop performance to lesson-04-01
const { enhanceLesson } = require('./enhance-lesson.js');

const coursePath = 'content/courses/csharp/course.json';
const moduleId = 'module-04';
const lessonId = 'lesson-04-01';
...
try {
  const added = enhanceLesson(coursePath, moduleId, lessonId, [deepDiveSection]);
  console.log(`Successfully added ${added} DEEP_DIVE section(s) to ${lessonId}`);
} catch (error) {
