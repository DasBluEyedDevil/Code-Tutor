...
Let us configure Spring Security for JWT-based stateless authentication. This setup disables sessions and CSRF (appropriate for API-only backends) and registers our custom JWT filter.
