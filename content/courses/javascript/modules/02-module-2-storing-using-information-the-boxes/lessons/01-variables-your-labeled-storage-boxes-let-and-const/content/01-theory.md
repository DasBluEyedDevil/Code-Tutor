...
Without variables, you'd have to remember the exact value or where it lives every time you need it. If you use the price of an item ($19.99) in ten different calculations and the price changes, you'd have to find and update all ten lines.

With a variable like `const basePrice = 19.99;`, you update it **once**, and the change ripples through your entire "warehouse" automatically.
