...
**`context(Raise<E>)` marks functions that can raise typed errors**. The context parameter requirement forces callers to provide error handling at compile-time—errors can't be ignored.
