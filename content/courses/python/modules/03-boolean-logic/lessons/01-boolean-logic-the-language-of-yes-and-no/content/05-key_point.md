...
- **Boolean values** are `True` or `False` (capitalized!) - the foundation of all program decisions
...
- **Store Boolean results** in variables with descriptive names for readable code
