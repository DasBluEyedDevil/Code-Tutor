...
<task type="auto">
  ...
  <done>All 812+ lesson.json files have lesson-{MM}-{LL} IDs. All module.json files have module-{NN} IDs. All moduleId references are consistent. All files validate against their schema (minus content type issues addressed in Plan 03).</done>
</task>
